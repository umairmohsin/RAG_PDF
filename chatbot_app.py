...
def main():
    ...
    st.markdown("<h3 style='text-align: center; color: grey;'>Built by <a href='https://github.com/AIAnytime'>Muhammad Umair with ❤️ </a></h3>", unsafe_allow_html=True)
